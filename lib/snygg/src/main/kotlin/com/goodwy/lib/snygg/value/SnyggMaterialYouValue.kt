...
import com.goodwy.lib.snygg.value.MaterialYouColor.ColorName
import com.goodwy.lib.snygg.value.MaterialYouColor.ColorNameId
import com.goodwy.lib.snygg.value.MaterialYouColor.darkColorName
import com.goodwy.lib.snygg.value.MaterialYouColor.lightColorName
    ...
    private fun getAndCacheColorScheme(context: Context, dark: Boolean): ColorScheme {
        return if (dark) {
            if (darkColorScheme == null) {
                ...
                else darkColorScheme() //TODO Goodwy. API themes are less than 31 if they use Material You colors
            }
            darkColorScheme!!
        } else {
            if (lightColorScheme == null) {
                lightColorScheme = if (ATLEAST_API31_S) dynamicLightColorScheme(context)
                else lightColorScheme() //TODO Goodwy. API themes are less than 31 if they use Material You colors
            }
            lightColorScheme!!
        }
    }
