...
package com.goodwy.keyboard.benchmark
...
abstract class AbstractStartupBenchmark(private val startupMode: StartupMode) {
    ...
    private fun startup(compilationMode: CompilationMode) = benchmarkRule.measureRepeated(
        packageName = "com.goodwy.keyboard",
        ...
        setupBlock = {
            pressHome()
            device.executeShellCommand("ime enable com.goodwy.keyboard/.FlorisImeService")
            device.executeShellCommand("ime set com.goodwy.keyboard/.FlorisImeService")
        }
    ) {
