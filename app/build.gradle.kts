...
android {
    ...
    defaultConfig {
        applicationId = "com.goodwy.keyboard"
    ...
    buildTypes {
        named("debug") {
            ...
            resValue("string", "floris_app_name", "Inkwell Debug")
        }
        ...
        create("beta") {
            ...
            resValue("string", "floris_app_name", "Inkwell Beta")
        }
        ...
        named("release") {
            ...
            resValue("string", "floris_app_name", "@string/app_name_g")
        }
