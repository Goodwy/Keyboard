...
import com.goodwy.keyboard.ime.input.InputFeedbackSoundEffect.KEYPRESS_STANDARD
import com.goodwy.keyboard.ime.input.InputFeedbackSoundEffect.KEY_CLICK
...
import com.goodwy.keyboard.ime.media.emoji.EmojiCategory.FLAGS
import com.goodwy.keyboard.ime.media.emoji.EmojiCategory.FOOD_DRINK
import com.goodwy.keyboard.ime.media.emoji.EmojiCategory.OBJECTS
import com.goodwy.keyboard.ime.media.emoji.EmojiCategory.PEOPLE_BODY
import com.goodwy.keyboard.ime.media.emoji.EmojiCategory.RECENTLY_USED
import com.goodwy.keyboard.ime.media.emoji.EmojiCategory.SMILEYS_EMOTION
...
private val ENUM_DISPLAY_ENTRIES = mapOf<Pair<KClass<*>, String>, @Composable () -> List<ListPreferenceEntry<*>>>(
    ...
    // Goodwy
    InputFeedbackSoundEffect::class to DEFAULT to {
        listPrefEntries {
            entry(
    ...
    EmojiCategory::class to DEFAULT to {
        listPrefEntries {
            entry(
                key = RECENTLY_USED,
