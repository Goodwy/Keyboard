...
package com.goodwy.keyboard.app.setup
...
import com.goodwy.keyboard.app.FlorisAppActivity
...
import com.goodwy.keyboard.lib.compose.FlorisStep
import com.goodwy.keyboard.lib.compose.FlorisStepLayout
...
private fun PreferenceUiScope<AppPrefs>.steps(
    ...
    return listOfNotNull(
        FlorisStep(
            ...
            click = { InputMethodUtils.showImeEnablerActivity(context) }
        ) {
        ...
        FlorisStep(
            ...
            click = { InputMethodUtils.showImePicker(context) }
        ) {
        ...
        if (AndroidVersion.ATLEAST_API33_T) {
            FlorisStep(
                ...
                click = { requestNotification.launch(android.Manifest.permission.POST_NOTIFICATIONS) }
            ) {
