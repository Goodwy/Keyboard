...
package com.goodwy.keyboard.lib.snygg.value
...
import com.goodwy.keyboard.app.apptheme.darkScheme
import com.goodwy.keyboard.app.apptheme.lightScheme
import com.goodwy.keyboard.lib.android.AndroidVersion.ATLEAST_API31_S
import com.goodwy.keyboard.lib.snygg.value.MaterialYouColor.ColorName
import com.goodwy.keyboard.lib.snygg.value.MaterialYouColor.ColorNameId
import com.goodwy.keyboard.lib.snygg.value.MaterialYouColor.darkColorName
import com.goodwy.keyboard.lib.snygg.value.MaterialYouColor.lightColorName
    ...
    private fun getAndCacheColorScheme(context: Context, dark: Boolean): ColorScheme {
        return if (dark) {
            if (darkColorScheme == null) {
                darkColorScheme = if (ATLEAST_API31_S) dynamicDarkColorScheme(context)
                else darkScheme //TODO Goodwy. API themes are less than 31 if they use Material You colors
            }
            darkColorScheme!!
        } else {
            if (lightColorScheme == null) {
                lightColorScheme = if (ATLEAST_API31_S) dynamicLightColorScheme(context)
                else lightScheme //TODO Goodwy. API themes are less than 31 if they use Material You colors
            }
            lightColorScheme!!
        }
    }
