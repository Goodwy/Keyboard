...
package com.goodwy.keyboard.lib.android
...
//launchUrl does not correctly handle links to open inside other applications, such as app stores.
fun Context.launchUrlNew(url: String) {
...
fun Context.launchUrlNew(url: Int) {
    launchUrlNew(this.stringRes(url))
}
