...
val SnyggVarValueEncoders = listOfNotNull(
    ...
    //TODO Goodwy. API themes are less than 31 if they use Material You colors
    SnyggMaterialYouLightColorValue, //if (AndroidVersion.ATLEAST_API31_S) SnyggMaterialYouLightColorValue else null,
    SnyggMaterialYouDarkColorValue, //if (AndroidVersion.ATLEAST_API31_S) SnyggMaterialYouDarkColorValue else null,
    //SnyggImageRefValue,
